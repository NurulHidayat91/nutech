...
<!-- 
              ...
              <h4 class="mt-3 badge bg-success">
                  <span style="font-size: x-large;">Stok : <?= $barang->stok?> </span>
                </h4>
                <hr>
              ...
              <div class="mt-4">
                <div class="row">
                  ...
                  <?php if (empty($barang->stok)) {?>
                    <div class="col-sm-8">
                      <button type="submit" class="btn btn-primary btn-flat swalDefaultSuccess" disabled>
